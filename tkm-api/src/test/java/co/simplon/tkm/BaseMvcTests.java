...
@Sql(scripts = { "classpath:db/schema-tests.ddl.sql",
		"classpath:db/data-tests.dml.sql" },
...
class BaseMvcTests {
    ...
    protected final ResultActions perform(String method, String path,
    String tokenName, String content) throws Exception {
		var builder = requestBuilder(method, path, tokenName, content);
		return mvc.perform(builder);
    }

    private MockHttpServletRequestBuilder requestBuilder(String method,
